...
static const KIOUHookEntry kCatalog[] = {
    ...
    { KIOU_HOOK_NAME_SYNC_ITEM_LIST_MERGE,        KIOU_KF_HOOK_SYNC_ITEM_LIST_MERGE,        KIOU_KF_SITE_RVA_SYNC_ITEM_LIST_MERGE        },
    { KIOU_HOOK_NAME_COLLECTION_PRESET_MERGE,     KIOU_KF_HOOK_COLLECTION_PRESET_MERGE,     KIOU_KF_SITE_RVA_COLLECTION_PRESET_MERGE     },
    { KIOU_HOOK_NAME_SELECT_CHAR_ASYNC,           KIOU_KF_HOOK_SELECT_CHAR_ASYNC,           KIOU_KF_SITE_RVA_SELECT_CHAR_ASYNC           },
    { KIOU_HOOK_NAME_SELECT_CHAR_REPLY_MERGE,     KIOU_KF_HOOK_SELECT_CHAR_REPLY_MERGE,     KIOU_KF_SITE_RVA_SELECT_CHAR_REPLY_MERGE     },
    { KIOU_HOOK_NAME_MATCHING_PLAYER_MERGE,       KIOU_KF_HOOK_MATCHING_PLAYER_MERGE,       KIOU_KF_SITE_RVA_MATCHING_PLAYER_MERGE       },
    { KIOU_HOOK_NAME_HISTORY_DETAIL_MERGE,        KIOU_KF_HOOK_HISTORY_DETAIL_MERGE,        KIOU_KF_SITE_RVA_HISTORY_DETAIL_MERGE        },
    { KIOU_HOOK_NAME_HISTORY_GET_PREMIUM,         KIOU_KF_HOOK_HISTORY_GET_PREMIUM,         KIOU_KF_SITE_RVA_HISTORY_GET_PREMIUM         },
    { KIOU_HOOK_NAME_KIFU_DETAIL_IS_PREMIUM,      KIOU_KF_HOOK_KIFU_DETAIL_IS_PREMIUM,      KIOU_KF_SITE_RVA_KIFU_DETAIL_IS_PREMIUM      },
    { KIOU_HOOK_NAME_VOICE_PLAYER_SATISFIES,      KIOU_KF_HOOK_VOICE_PLAYER_SATISFIES,      KIOU_KF_SITE_RVA_VOICE_PLAYER_SATISFIES      },
    { KIOU_HOOK_NAME_VOICE_CELL_GET_IS_LOCKED,    KIOU_KF_HOOK_VOICE_CELL_GET_IS_LOCKED,    KIOU_KF_SITE_RVA_VOICE_CELL_GET_IS_LOCKED    },
    { KIOU_HOOK_NAME_BSE_CTOR,                    KIOU_KF_HOOK_BSE_CTOR,                    KIOU_KF_SITE_RVA_BSE_CTOR                    },
    { KIOU_HOOK_NAME_BSE_ENSURE_INITIALIZED,      KIOU_KF_HOOK_BSE_ENSURE_INITIALIZED,      KIOU_KF_SITE_RVA_BSE_ENSURE_INITIALIZED      },
    { KIOU_HOOK_NAME_RBSUPPORT_GET_ENABLED,       KIOU_KF_HOOK_RBSUPPORT_GET_ENABLED,       KIOU_KF_SITE_RVA_RBSUPPORT_GET_ENABLED       },
    { KIOU_HOOK_NAME_RBSUPPORT_GET_DEPTH,         KIOU_KF_HOOK_RBSUPPORT_GET_DEPTH,         KIOU_KF_SITE_RVA_RBSUPPORT_GET_DEPTH         },
    { KIOU_HOOK_NAME_HOME_UTILITY_PRESENTER_CTOR, KIOU_KF_HOOK_HOME_UTILITY_PRESENTER_CTOR, KIOU_KF_SITE_RVA_HOME_UTILITY_PRESENTER_CTOR },
    { KIOU_HOOK_NAME_UIBUTTONBASE_ONPOINTERCLICK, KIOU_KF_HOOK_UIBUTTONBASE_ONPOINTERCLICK, KIOU_KF_SITE_RVA_UIBUTTONBASE_ONPOINTERCLICK },
    { KIOU_HOOK_NAME_TITLE_SCENE_MOVENEXT,        KIOU_KF_HOOK_TITLE_SCENE_MOVENEXT,        KIOU_KF_SITE_RVA_TITLE_SCENE_MOVENEXT        },
    { KIOU_HOOK_NAME_GAME_ORCHESTRATOR_IS_AFK,    KIOU_KF_HOOK_GAME_ORCHESTRATOR_IS_AFK,    KIOU_KF_SITE_RVA_GAME_ORCHESTRATOR_IS_AFK    },
    ...
    { KIOU_HOOK_NAME_NSS_SETHASHSIZE_DIRECT,      -1,                                       KIOU_KF_SITE_RVA_NSS_SETHASHSIZE_DIRECT      },
    { KIOU_HOOK_NAME_GAMEOBJECT_GETCOMPONENT,     -1,                                       KIOU_KF_SITE_RVA_GAMEOBJECT_GETCOMPONENT     },
    { KIOU_HOOK_NAME_RTU_WORLDTOSCREENPOINT,      -1,                                       KIOU_KF_SITE_RVA_RTU_WORLDTOSCREENPOINT      },
    { NULL,                                        0,                                       0                                            },
};
