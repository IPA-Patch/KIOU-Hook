...
HOOK_IDS: dict[str, int] = {
    ...
    # Additional CAVE_ENTRY hooks
    "KIOU_HOOK_ID_HEADER_PROVIDER_SET_OR_UPDATE_HEADER": 15,
    # KiouEditor CAVE_ENTRY hooks (1.0.1)
    "KIOU_HOOK_ID_SYNC_ITEM_LIST_MERGE":         16,
    "KIOU_HOOK_ID_COLLECTION_PRESET_MERGE":      17,
    "KIOU_HOOK_ID_SELECT_CHAR_ASYNC":            18,
    "KIOU_HOOK_ID_SELECT_CHAR_REPLY_MERGE":      19,
    "KIOU_HOOK_ID_MATCHING_PLAYER_MERGE":        20,
    "KIOU_HOOK_ID_HISTORY_DETAIL_MERGE":         21,
    "KIOU_HOOK_ID_HISTORY_GET_PREMIUM":          22,
    "KIOU_HOOK_ID_KIFU_DETAIL_IS_PREMIUM":       23,
    "KIOU_HOOK_ID_VOICE_PLAYER_SATISFIES":       24,
    "KIOU_HOOK_ID_VOICE_CELL_GET_IS_LOCKED":     25,
    "KIOU_HOOK_ID_BSE_CTOR":                     26,
    "KIOU_HOOK_ID_BSE_ENSURE_INITIALIZED":       27,
    "KIOU_HOOK_ID_RBSUPPORT_GET_ENABLED":        28,
    "KIOU_HOOK_ID_RBSUPPORT_GET_DEPTH":          29,
    "KIOU_HOOK_ID_HOME_UTILITY_PRESENTER_CTOR":  30,
...
ENTRY_SLOT_INDEX: dict[str, int] = {
    ...
    "KIOU_HOOK_ID_GET_SELF_PROFILE_MOVENEXT": 8,
    "KIOU_HOOK_ID_HTTPMSGINVOKER_SEND_ASYNC": 9,
    # Additional CAVE_ENTRY slots
    "KIOU_HOOK_ID_HEADER_PROVIDER_SET_OR_UPDATE_HEADER": 10,
    # KiouEditor CAVE_ENTRY slots (1.0.1)
    "KIOU_HOOK_ID_SYNC_ITEM_LIST_MERGE":         11,
    "KIOU_HOOK_ID_COLLECTION_PRESET_MERGE":      12,
    "KIOU_HOOK_ID_SELECT_CHAR_ASYNC":            13,
    "KIOU_HOOK_ID_SELECT_CHAR_REPLY_MERGE":      14,
    "KIOU_HOOK_ID_MATCHING_PLAYER_MERGE":        15,
    "KIOU_HOOK_ID_HISTORY_DETAIL_MERGE":         16,
    "KIOU_HOOK_ID_HISTORY_GET_PREMIUM":          17,
    "KIOU_HOOK_ID_KIFU_DETAIL_IS_PREMIUM":       18,
    "KIOU_HOOK_ID_VOICE_PLAYER_SATISFIES":       19,
    "KIOU_HOOK_ID_VOICE_CELL_GET_IS_LOCKED":     20,
    "KIOU_HOOK_ID_BSE_CTOR":                     21,
    "KIOU_HOOK_ID_BSE_ENSURE_INITIALIZED":       22,
    "KIOU_HOOK_ID_RBSUPPORT_GET_ENABLED":        23,
    "KIOU_HOOK_ID_RBSUPPORT_GET_DEPTH":          24,
    "KIOU_HOOK_ID_HOME_UTILITY_PRESENTER_CTOR":  25,
