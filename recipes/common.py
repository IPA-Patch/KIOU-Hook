...
# ---------------------------------------------------------------------------
# Hook ID enum — mirrors ``enum kiou_hook_id`` in KIOUHook.h.
...
HOOK_IDS: dict[str, int] = {
    ...
    "KIOU_HOOK_ID_NSS_SETHASHSIZE":           1,
    "KIOU_HOOK_ID_NSS_SETSKILLEVEL":          2,
    "KIOU_HOOK_ID_NSS_SEARCHFULL":            3,
    "KIOU_HOOK_ID_ACCOUNT_EXISTS":            4,
    "KIOU_HOOK_ID_LOGIN_ARGS_CREATE":         5,
    "KIOU_HOOK_ID_REGISTER_USER_ARGS_CREATE": 6,
    "KIOU_HOOK_ID_RUN_LOGIN_SEQ_MOVENEXT":    7,
    "KIOU_HOOK_ID_GET_SELF_PROFILE_MOVENEXT": 8,
    "KIOU_HOOK_ID_HTTPMSGINVOKER_SEND_ASYNC": 9,
    # CAVE_OBSERVER hooks (kifu autosave, one per IMatchMode)
    "KIOU_HOOK_ID_KIFU_AI_END":        10,
    "KIOU_HOOK_ID_KIFU_CPUSTREAM_END": 11,
    "KIOU_HOOK_ID_KIFU_LOCAL_END":     12,
    "KIOU_HOOK_ID_KIFU_ONLINE_END":    13,
    "KIOU_HOOK_ID_KIFU_REPLAY_END":    14,
    # KiouEditor CAVE_ENTRY hooks (1.0.1)
    "KIOU_HOOK_ID_SYNC_ITEM_LIST_MERGE":         15,
    "KIOU_HOOK_ID_COLLECTION_PRESET_MERGE":      16,
    "KIOU_HOOK_ID_SELECT_CHAR_ASYNC":            17,
    "KIOU_HOOK_ID_SELECT_CHAR_REPLY_MERGE":      18,
    "KIOU_HOOK_ID_MATCHING_PLAYER_MERGE":        19,
    "KIOU_HOOK_ID_HISTORY_DETAIL_MERGE":         20,
    "KIOU_HOOK_ID_HISTORY_GET_PREMIUM":          21,
    "KIOU_HOOK_ID_KIFU_DETAIL_IS_PREMIUM":       22,
    "KIOU_HOOK_ID_VOICE_PLAYER_SATISFIES":       23,
    "KIOU_HOOK_ID_VOICE_CELL_GET_IS_LOCKED":     24,
    "KIOU_HOOK_ID_BSE_CTOR":                     25,
    "KIOU_HOOK_ID_BSE_ENSURE_INITIALIZED":       26,
    "KIOU_HOOK_ID_RBSUPPORT_GET_ENABLED":        27,
    "KIOU_HOOK_ID_RBSUPPORT_GET_DEPTH":          28,
    "KIOU_HOOK_ID_HOME_UTILITY_PRESENTER_CTOR":  29,
    "KIOU_HOOK_ID_UIBUTTONBASE_ONPOINTERCLICK":  30,
    "KIOU_HOOK_ID_TITLE_SCENE_MOVENEXT":         31,
    "KIOU_HOOK_ID_GAME_ORCHESTRATOR_IS_AFK":     32,
}
...
ENTRY_SLOT_INDEX: dict[str, int] = {
    ...
    "KIOU_HOOK_ID_SYNC_ITEM_LIST_MERGE":         10,
    "KIOU_HOOK_ID_COLLECTION_PRESET_MERGE":      11,
    "KIOU_HOOK_ID_SELECT_CHAR_ASYNC":            12,
    "KIOU_HOOK_ID_SELECT_CHAR_REPLY_MERGE":      13,
    "KIOU_HOOK_ID_MATCHING_PLAYER_MERGE":        14,
    "KIOU_HOOK_ID_HISTORY_DETAIL_MERGE":         15,
    "KIOU_HOOK_ID_HISTORY_GET_PREMIUM":          16,
    "KIOU_HOOK_ID_KIFU_DETAIL_IS_PREMIUM":       17,
    "KIOU_HOOK_ID_VOICE_PLAYER_SATISFIES":       18,
    "KIOU_HOOK_ID_VOICE_CELL_GET_IS_LOCKED":     19,
    "KIOU_HOOK_ID_BSE_CTOR":                     20,
    "KIOU_HOOK_ID_BSE_ENSURE_INITIALIZED":       21,
    "KIOU_HOOK_ID_RBSUPPORT_GET_ENABLED":        22,
    "KIOU_HOOK_ID_RBSUPPORT_GET_DEPTH":          23,
    "KIOU_HOOK_ID_HOME_UTILITY_PRESENTER_CTOR":  24,
    "KIOU_HOOK_ID_UIBUTTONBASE_ONPOINTERCLICK":  25,
    "KIOU_HOOK_ID_TITLE_SCENE_MOVENEXT":         26,
    "KIOU_HOOK_ID_GAME_ORCHESTRATOR_IS_AFK":     27,
}
