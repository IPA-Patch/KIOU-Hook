...
SITES = [
    ...
    (0x5C37034, "fc6fbaa9", "KIOU_KF_HOOK_SYNC_ITEM_LIST_MERGE",        CAVE_ENTRY, "SyncItemListReply.InternalMergeFrom"),
    (0x5C4065C, "fa67bba9", "KIOU_KF_HOOK_COLLECTION_PRESET_MERGE",     CAVE_ENTRY, "UpdateCollectionPresetReply.InternalMergeFrom"),
    (0x5CA7C90, "ffc302d1", "KIOU_KF_HOOK_SELECT_CHAR_ASYNC",           CAVE_ENTRY, "SelectCharacterAsync"),
    (0x5C26DCC, "fc6fbaa9", "KIOU_KF_HOOK_SELECT_CHAR_REPLY_MERGE",     CAVE_ENTRY, "SelectCharacterReply.InternalMergeFrom"),
    (0x5B4CAEC, "fc6fbaa9", "KIOU_KF_HOOK_MATCHING_PLAYER_MERGE",       CAVE_ENTRY, "ShogiMatchingPlayerStatus.InternalMergeFrom"),
    (0x5C01328, "fc6fbaa9", "KIOU_KF_HOOK_HISTORY_DETAIL_MERGE",        CAVE_ENTRY, "GetShogiHistoryDetailListReply.InternalMergeFrom"),
    (0x5C00D88, "00804039", "KIOU_KF_HOOK_HISTORY_GET_PREMIUM",         CAVE_ENTRY, "GetShogiHistoryDetailListReply.get_IsPremiumUser"),
    (0x585B25C, "00004139", "KIOU_KF_HOOK_KIFU_DETAIL_IS_PREMIUM",      CAVE_ENTRY, "KifuDetailModel.IsPremiumUser"),
    (0x582B88C, "e80300aa", "KIOU_KF_HOOK_VOICE_PLAYER_SATISFIES",      CAVE_ENTRY, "CharacterVoicePlayer.SatisfiesRule"),
    (0x584ADC0, "00704039", "KIOU_KF_HOOK_VOICE_CELL_GET_IS_LOCKED",    CAVE_ENTRY, "CharacterVoiceScrollerCellModel.get_IsLocked"),
    (0x597A448, "f85fbca9", "KIOU_KF_HOOK_BSE_CTOR",                    CAVE_ENTRY, "BeginnerSupportEvaluator.ctor"),
    (0x597BAFC, "f657bda9", "KIOU_KF_HOOK_BSE_ENSURE_INITIALIZED",      CAVE_ENTRY, "BeginnerSupportEvaluator.EnsureInitializedLocked"),
    (0x593E630, "00404039", "KIOU_KF_HOOK_RBSUPPORT_GET_ENABLED",       CAVE_ENTRY, "ResolvedBeginnerSupport.get_Enabled"),
    (0x593E650, "002040b9", "KIOU_KF_HOOK_RBSUPPORT_GET_DEPTH",         CAVE_ENTRY, "ResolvedBeginnerSupport.get_Depth"),
    (0x5A9F298, "fc6fbaa9", "KIOU_KF_HOOK_HOME_UTILITY_PRESENTER_CTOR", CAVE_ENTRY, "HomeUtilityPresenter.ctor"),
    (0x5DD1E08, "f44fbea9", "KIOU_KF_HOOK_UIBUTTONBASE_ONPOINTERCLICK", CAVE_ENTRY, "UIButtonBase.OnPointerClick"),
    (0x5DCC728, "ff0303d1", "KIOU_KF_HOOK_TITLE_SCENE_MOVENEXT",        CAVE_ENTRY, "TitleScene+<OnActivateAsync>d__10.MoveNext"),
